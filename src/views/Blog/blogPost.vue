<template>
  <main>
    ...
    <div class="container md:p-10 p-5 pt-5">
        <div class="nav mb-8">
  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-3">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <div class="grid grid-cols- md:grid-cols-3 gap-8">
            <div class="col-span-2">
                <h1 class="md:text-3xl lg:text-5xl text-2xl pb-4">
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Obcaecati impedit velit totam?
                    </h1>

                    <small class="text-gray-400 flex text-md mb-3 pt-1">
                                        <span>
                                            <Icon icon="mingcute:user-4-fill" color="skyblue" width="28" />
                                        </span> <span class="mt-1 mx-1">By Admin</span> 
                                        <Icon icon="mdi:clock-outline" color="skyblue" class="mt-2 ml-4" />
                                        <span class="mx-1 mt-1">October 24, 2023</span>
                                    </small>
                <img src="../../assets/img/img.jpg" alt="" class="rounded">

                <div class="flex items-center space-x-4 my-3">
    <span class="text-gray-600">0 Shares</span>
    <a  class="bg-blue-500 hover:bg-blue-600 text-white px-3 py-2 rounded-lg transition duration-300">
        <Icon icon="ri:facebook-fill" />
    </a>

    <a  class="bg-green-500 hover:bg-green-600 text-white px-3 py-2 rounded-lg transition duration-300">
        <Icon icon="ic:baseline-whatsapp" />
    </a>

    <a  class="bg-blue-400 hover:bg-blue-400 text-white px-3 py-2 rounded-lg transition duration-300">
        <Icon icon="mdi:twitter" />
    </a>
  </div>
                <div class="text-left my-3 p-3">
                   

                    <p class="text-gray-700 text-md py-3">
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, voluptatibus excepturi, et quidem, corporis aliquam in suscipit laboriosam provident nam incidunt fugiat amet perferendis! Molestias aliquid veniam laudantium nobis placeat, odit natus itaque culpa architecto impedit! Molestias eos nisi, maiores fugit neque dolorum ut voluptates quam at dolores earum adipisci laudantium, vero tempore excepturi? Odio eaque illo totam aliquam, consequatur dicta neque excepturi perspiciatis dolorum eveniet saepe dolor iste impedit sapiente, at suscipit! Harum veritatis, exercitationem provident soluta nostrum perferendis molestias vero dolore voluptatum, asperiores praesentium, sint ex corporis a! 
                        <br />
                        <br />
                        
                        Perspiciatis placeat aliquid mollitia voluptas aspernatur, itaque consectetur consequuntur quam, dicta alias quod quasi nesciunt ratione non ea? Aliquid animi doloribus corporis quis maxime cumque debitis numquam dolor sequi assumenda consequatur natus, voluptates at, quia iusto explicabo quibusdam tempora delectus sapiente optio nostrum placeat ad harum atque. Inventore incidunt debitis eos magni soluta blanditiis, autem iste facere tenetur quo exercitationem?
                    </p>
                </div>
            </div>

            <div class="col">
                <div class="follow w-100 bg-gray-300 px-10 py-10 pt-5 rounded">
                            <h6 class="text-1xl">Follow us</h6>
                            <p class="text-gray-500">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                            <div class="socials my-3 flex">
                                <div class="handle bg-black rounded-full w-8 h-8 pl-2 pt-2 mr-2">
                            ...
                            <hr class="bg-gray-900 border border-gray-500 border-1 text-gray-900" />

                            <h6 class="text-1xl pt-3">Get latest new delivered daily</h6>
